...
class ShapeAnalyzer:
    ...
    def scale_contour(self, contour, distance):
        ...
        return (contour * scale_factor).astype('int')
    ...
    @staticmethod
    def save(mask, distance):
        np.savez_compressed('shape_analysis_input', mask=mask, distance=distance)
